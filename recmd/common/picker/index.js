...
class DatePicker extends Component {
    ...
    getTitleElement() {
        ...
        if (!date && placeholder) {
            return (
                <Text style={[Style.placeholderText, this.props.customStyles.placeholderText]}>{placeholder}</Text>);
        }
    ...
    onDatetimePicked({action, year, month, day}) {
        if (action !== DatePickerAndroid.dismissedAction) {
            ...
            let hourAndMinute = this.props.minTime.split(':')
    ...
    onPressDate(date = null) {
        ...
        // reset state
        this.setState({
            date: date ? this.getDate(date) : this.getDate()
        });
        if (Platform.OS === 'ios') {
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <Text
                                            style={[Style.btnTextText, customStyles.btnTextConfirm]}>{this.props.confirmBtnText}</Text>
                                    </TouchableHighlight>
                                </Animated.View>
                            </TouchableHighlight>
                        </TouchableHighlight>

        ...
        return (
            <View style={styles.container}>
                <View
                    ...
                    <Text style={{flex: 3, textAlign: 'right',color:'#666'}}>¥{ticket.RealPrice}元/人</Text>
                </View>
                <View
                    style={[styles.item, styles.item_height]}>
                    <Text style={{flex: 3, fontSize: 18,color:'#3d3d3d',marginLeft:-4}}> {ticket.from.time}</Text>
                    <Text style={{
                        flex: 5,
                        color: '#666666',
                        textAlign: 'center',
                        color:'#999',
                        fontSize:12
                    }}> {ticket.CarrierName} {ticket.FlightNo}</Text>
                ...
                <View
                    ...
                    <Text style={{flex: 3, fontSize: 16,marginLeft:-4}}> {ticket.from.address}</Text>

                    <UseTime  minutes={ticket.use_time|| 230}/>
                    <Text style={{flex: 3, fontSize: 16, textAlign: 'right',marginLeft:-4}}>{ticket.to.address}</Text>
                ...
                <View
                    ...
                    <Text style={{
                        ...
                        fontSize: 14,
                        textAlign: 'left'
                    }}> {ticket.from.station} {ticket.Departterminalname}</Text>
                    <Button/>
                    <Text style={{
                        flex: 4,
                        fontSize: 14,
                        textAlign: 'right'
                    }}>{ticket.to.station} {ticket.Arriveterminalname}</Text>
